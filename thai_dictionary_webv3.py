...
if "users" not in st.session_state:
    # ตัวอย่าง user database (รหัสผ่าน hashed)
...
# สร้างค่าเริ่มต้น session_state ที่ใช้
if "new_desc" not in st.session_state:
    st.session_state["new_desc"] = ""

# เช็ค query param เพื่อ refresh (ถ้ามี)
...
if query:
    ...
    if query in memory:
        ...
        for i, item in enumerate(memory[query]):
            ...
            # ลบเฉพาะเจ้าของคำอธิบายเท่านั้น
