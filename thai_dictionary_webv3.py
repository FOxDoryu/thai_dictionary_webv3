...
# Check query params for refresh
if st.query_params.get("refresh", ["false"])[0] == "true":
    # Clear the refresh param and rerun once safely
...
if query:
    ...
    if st.button("💾 บันทึก"):
        if query and user_name and new_desc:
            ...
            st.set_query_params(refresh="true")  # trigger rerun
