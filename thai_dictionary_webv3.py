        ...
        if st.button("สมัครสมาชิก"):
            if username and password:
                if username in st.session_state.users:
                    st.session_state.login_error = "ชื่อผู้ใช้นี้มีอยู่แล้ว"
                else:
                    st.session_state.users[username] = {"password": hash_password(password)}
                    st.session_state.login_error = "สมัครสมาชิกสำเร็จ! กรุณาเข้าสู่ระบบ"
            else:
                st.session_state.login_error = "กรุณากรอกชื่อและรหัสผ่าน"
