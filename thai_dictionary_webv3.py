...
# ใช้ query params รีโหลดแทน experimental_rerun
if st.experimental_get_query_params().get("refresh", ["false"])[0] == "true":
    st.experimental_set_query_params(refresh="false")
    st.experimental_rerun()  # นี่เป็น rerun ปลอดภัยในจุดเดียว
