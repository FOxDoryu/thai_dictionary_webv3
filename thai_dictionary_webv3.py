...
# Email sending function (ตั้งค่าให้ถูกต้องก่อนใช้งานจริง)
SMTP_SERVER = "c92fb1a39177153b474a00d3f9eb3c2eed80a55b858ba711c1b2b710f0ed84ef"
SMTP_PORT = 587
SMTP_EMAIL = "guzz9777@gmail.com"  # ใส่อีเมลจริงที่ใช้ส่ง OTP
SMTP_PASSWORD = "pqgo hjcx dbqm pjsk"  # ใช้ App Password ของ Gmail (2FA)
    ...
    if query:
        ...
        if query in memory:
            ...
            for i, item in enumerate(memory[query]):
                ...
                if item["name"] == st.session_state.username:
